...
<body style="background-color: #303030; color: #D3D3D3;">
	<div class="container">
		...
		<c:if test="${not empty param.uploaded && param.uploaded == '0'}">
			<div class="alert alert-danger" role="alert">The uploading process encountered an error. Please retry.</div>
		</c:if>

		<c:if test="${not empty param.uploaded && param.uploaded == '1'}">
	                    ...
	                    <div class="modal-body">
		                   <div class="col-auto">
						      ...
						      <div class="input-group mb-2">
						        ...
						        <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="name_of_file.png">
						      </div>
						    </div>	
	                    </div>
                    </form>
      ...
      <c:if test="${files.rowCount > 0}">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content bg-dark">
					...
					<div class="modal-body">Are you sure you want to permanently
						delete your iNuage account ?</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary"
							data-dismiss="modal">No</button>
						<a href="iNuage/action?c=delete"><button type="button"
		...
		<small class="d-block text-right mt-3" data-toggle="modal"
			data-target="#accountDeleter"
			style="cursor: pointer; color: #0376D1;">Delete Account</small>
	</div>
</body>
